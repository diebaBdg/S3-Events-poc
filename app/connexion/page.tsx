...
export default function ConnexionPage() {
  ...
  // SAFE URL PARAM HANDLING (Netlify + Next.js friendly)
  useEffect(() => {
              ...
              <div className="text-center py-8">
                ...
                <p className="text-foreground/60 mb-6">
                  {isLogin
                    ...
                    : "Bienvenue sur S3 Events ! Vous pouvez maintenant réserver vos prestataires."}
                </p>
              ...
              <>
                <div className="text-center mb-8">
                  ...
                  <p className="text-foreground/60 mt-2">
                    {isLogin
                      ? "Connectez-vous à votre compte S3 Events"
